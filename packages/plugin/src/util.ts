...
/**
 * Reads a custom package from the current node_modules directory
 * @param name Name of the custom package to read
 * @returns The custom package or undefined if it does not exist
 */
...
/**
 * Updates a custom package with a new Typescript declaration file
 * This is used to create type stubs for autogenerated bindings
 * @param packageName Name of the custom package to update
 * @param declarationFileName Name of the Typescript declaration file to update
 * @param declaration Contents of the Typescript declaration file to update
 */
